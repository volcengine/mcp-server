...
def create_runtime(
    ...
    return SupabaseRuntime(
        ...
        edge_tools=EdgeFunctionTools(client, default_project_id),
        storage_tools=StorageTools(client, default_project_id),
        database_tools=DatabaseTools(client, default_project_id),
        workspace_tools=WorkspaceTools(client, default_project_id),
    )
