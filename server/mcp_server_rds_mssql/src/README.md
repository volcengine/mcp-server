...
- **详细描述**: 创建云数据库SQL Server版实例，需指定版本、类型、可用区、规格、存储、网络、计费方式等参数。  
- **触发示例**: `"创建一个SQL Server 2019标准版的高可用实例，节点规格rds.mssql.se.ha.d4.4c16g，存储空间100GiB, vpc id为vpc-30uk7***， 子网id为subnet-3jh8xar****，按量付费"`  
