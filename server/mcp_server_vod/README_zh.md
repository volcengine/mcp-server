...
| 模⁠式⁠                                        | 适⁠用⁠场⁠景⁠                                   | 接⁠入⁠方⁠式⁠                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| --------------------------------------------- | ---------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **本⁠地⁠模⁠式⁠ (⁠J⁠S⁠O⁠N⁠&#160;L⁠o⁠c⁠a⁠l⁠)⁠** | 个人快速调试、处理本地敏感文件、无需公网域名。 | 通过 `uvx` 命令直接调用本地脚本运行。您可直接跳转至[步骤 2：添加 MCP 配置](#步骤-2添加-mcp-配置)。                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| **云⁠端⁠模⁠式⁠ (⁠J⁠S⁠O⁠N⁠&#160;U⁠R⁠L⁠)⁠**     | 长期稳定使用、跨团队协作、无需本地安装环境。   | 前往[火山引擎 MCP 广场](https://www.volcengine.com/mcp-marketplace/detail?name=VeVOD%20MCP)，在 Trae 页签下，单击**云部署**生成专属长效 URL。复制该 URL 后，前往[步骤 2：添加 MCP 配置](#步骤-2添加-mcp-配置)。<br>![云部署配置示意图](https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/287e233f0fbd45ff89eb44db0b1d5db5~tplv-goo7wpa0wc-image.image)<br>此方式需账户余额不少于 100 元，涉及 [API 网关](https://www.volcengine.com/docs/6569/185249?lang=zh)及[函数服务](https://www.volcengine.com/docs/6662/1269135?lang=zh)计费。 |
...
请根据您在步骤 1 选择的模式，查看下方对应小节并复制 JSON 进行替换。
...
![选择 Builder with MCP 模式](https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/b38f1ab590d74168b898b974d7d9240f~tplv-goo7wpa0wc-image.image)
您可以直接下达提示词，例如：帮我将 test 空间中的 beach.mp4 和 sunset.mp4 拼接在一起，中间加一个“淡入淡出”转场效果，完成后把播放地址发给我。

| 阶⁠段⁠           | 内⁠容⁠                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| ---------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **输⁠入⁠视⁠频⁠** | 📹 [输入视频1](https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/1814f820a644484486417c3a40ce8ac3~tplv-goo7wpa0wc-image.image) 📹 [输入视频2](https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/9add04fef4df4aef8ae66c1507326696~tplv-goo7wpa0wc-image.image)                                                                                                                                                                                                                |
| **处⁠理⁠过⁠程⁠** | 您将观察到：<br><br>· 自主规划：智能体将自动识别出需要调用 `audio_video_stitching` 工具。<br>· 异步追踪：由于云端剪辑需要时间，智能体会提交任务并返回一个任务标识（TaskID），并在后台自动轮询进度。如果您发现对话中断，可以手动追问："刚才的任务处理完了吗？"。<br>· 结果交付：任务完成后，智能体会直接给出生成的视频信息以及预览链接。<br><br>![任务执行过程](https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/255337623fcf4cdaa2fac5776b76a97c~tplv-goo7wpa0wc-image.image) |
| **输⁠出⁠视⁠频⁠** | 📹 [输出视频](https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/faac6d11638841b2ab84953437c49560~tplv-goo7wpa0wc-image.image)                                                                                                                                                                                                                                                                                                                                                  |
...
| 输⁠入⁠视⁠频⁠                                                                                                                    | 输⁠出⁠视⁠频⁠                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------- |
| 📹 [输入视频](https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/5750e89648104f9aab4ffd1421b25129~tplv-goo7wpa0wc-image.image) | 📹 [输出视频](https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/ee97af04ec7445ce91586cd34a03927f~tplv-goo7wpa0wc-image.image) |
...
| 输⁠入⁠视⁠频⁠                                                                                                                    | 输⁠出⁠视⁠频⁠                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------- |
| 📹 [输入视频](https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/314e504b12de45a5892d7cc7a34aa1e2~tplv-goo7wpa0wc-image.image) | 📹 [输出视频](https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/7d05d8fab9d34ac2844170ef17a6a19a~tplv-goo7wpa0wc-image.image) |
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>x⁠-⁠t⁠t⁠-⁠r⁠e⁠g⁠i⁠o⁠n⁠</td>
      <td>VOLCENGINE_REGION</td>
      <td>cn-north-1</td>
      <td>视频点播服务所在的地域</td>
    </tr>
    <tr>
      <td>x⁠-⁠t⁠t⁠-⁠s⁠e⁠s⁠s⁠i⁠o⁠n⁠-⁠t⁠o⁠k⁠e⁠n⁠</td>
